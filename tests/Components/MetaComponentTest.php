...
class MetaComponentTest extends TestCase
{
    ...
    {
        $blade = $this->blade('<x-fj-meta-tags />');
    ...
    {
        $blade = $this->blade('<x-fj-meta-tags title="dummy-title"/>');
    ...
    {
        $blade = $this->blade('<x-fj-meta-tags description="dummy-description"/>');
    ...
    {
        $blade = $this->blade('<x-fj-meta-tags keywords="keyword1,keyword2"/>');
